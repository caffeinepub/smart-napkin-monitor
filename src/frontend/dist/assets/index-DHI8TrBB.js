...
function Nav() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-purple-950/95 shadow-lg shadow-purple-900/30" : "bg-purple-950/80 backdrop-blur-md"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 font-poppins font-bold text-lg", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center glow-pulse", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 16, className: "text-white" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-200 hidden sm:block", children: "Smart Napkin Monitor" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-200 sm:hidden", children: "SNM" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center gap-1", children: NAV_LINKS.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:hidden bg-purple-950/95 border-t border-purple-800/50 px-4 pb-4 space-y-1", children: [
...
function Hero() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #1a0f35 0%, #2d1b69 50%, #0f0a1e 100%)"
      },
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AnimSection, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-1.5 bg-purple-900/60 border border-purple-500/40 rounded-full text-purple-300 text-sm font-semibold mb-6 backdrop-blur-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { size: 14 }),
              "Engineering Innovation Project"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-poppins font-bold text-4xl sm:text-5xl lg:text-5xl xl:text-6xl leading-tight text-white mb-4", children: [
              "Smart Sanitary",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xl font-semibold text-purple-300 mb-4", children: "Ready to Protect Women" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/80 text-base leading-relaxed mb-8 max-w-lg", children: "A revolutionary wearable health-monitoring device that uses conductive thread, NFC technology, and ESP32 to detect moisture levels in real-time — keeping women safe, healthy, and informed." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-72 h-72 sm:w-80 sm:h-80", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-purple-700 px-4 py-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-1 bg-white/30 rounded mx-auto mb-2" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-xs font-semibold text-center", children: "Napkin Monitor" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-3 space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-green-300 font-medium", children: "Dry — Safe" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-yellow-300 font-medium", children: "Moderate" })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
                        ...
                        children: [
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-red-300 font-medium", children: "Wet — Alert!" })
                        ]
                      }
                    )
                  ] })
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 20, className: "text-purple-400" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { size: 16, className: "text-white" })
              }
            )
          ] }) }) })
        ] }) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Live Status Dashboard" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300 text-base", children: "Real-time moisture level monitoring for device SN-001" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: [
              {
                label: "Dry",
                badge: "Safe",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 32, className: "text-green-400" }),
              ...
              },
              {
                label: "Moderate",
                badge: "Caution",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 32, className: "text-yellow-400" }),
              ...
              },
              {
                label: "Wet",
                badge: "Alert!",
                icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 32, className: "text-red-400" }),
            ...
            ].map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": s.ocid,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-3", children: s.icon }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-bold text-white text-lg mb-2", children: s.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-400 text-xs mt-3", children: s.time })
                ]
              }
            ) }, s.label))
          }
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20", style: { background: "#0f0a1e" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "About the Project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-8 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-bold text-xl text-white mb-4", children: "Our Mission" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/80 leading-relaxed mb-4", children: "The Smart Sanitary Napkin Monitoring System is an engineering innovation designed to address the critical health challenge of menstrual hygiene management in developing countries." }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/80 leading-relaxed", children: "By integrating conductive threads, NFC technology, and the ESP32 microcontroller, we've created an affordable, smart system that monitors moisture levels in real-time and sends instant alerts — all for under ₹250." })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: 150, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-4", children: [
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { size: 24, className: "text-purple-400" }),
          label: "Women's Health",
          sub: "Primary focus"
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 24, className: "text-purple-400" }),
          label: "Real-Time",
          sub: "Instant alerts"
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 24, className: "text-purple-400" }),
          label: "Affordable",
          sub: "Under ₹250"
        },
        {
          icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { size: 24, className: "text-purple-400" }),
          label: "Mobile-First",
          sub: "Smart alerts"
        }
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-2", children: item.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-white text-sm", children: item.label }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-400 text-xs", children: item.sub })
          ]
        },
        item.label
      )) }) })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Feasibility" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: [
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 28, className: "text-purple-400" }),
            title: "Ease of Use",
            desc: "No technical expertise required. Standard smartphone with Bluetooth/NFC reader is all that's needed."
          },
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 28, className: "text-purple-400" }),
            title: "Cost-Effective",
            desc: "Total system cost under ₹250, making it accessible for women across all economic backgrounds."
          },
          {
            icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 28, className: "text-purple-400" }),
            title: "Reliable & Safe",
            desc: "Tested for accuracy and durability with biocompatible materials safe for body contact."
          }
        ].map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-white text-base mb-2", children: card.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/70 text-sm leading-relaxed", children: card.desc })
            ]
          }
        ) }, card.title)) })
      ] })
...
const STEPS = [
  {
    num: "01",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { size: 28, className: "text-white" }),
  ...
  {
    num: "02",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Zap, { size: 28, className: "text-white" }),
    title: "NFC Tag",
  ...
  {
    num: "03",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { size: 28, className: "text-white" }),
    title: "ESP32 Module",
  ...
  {
    num: "04",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { size: 28, className: "text-white" }),
    title: "Mobile Alert",
...
function HowItWorks() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "How It Works" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "A seamless 4-step process from detection to alert" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: STEPS.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              i < STEPS.length - 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { size: 16, className: "text-purple-300" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center mx-auto mb-4 shadow-lg", children: step.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-purple-400 font-poppins font-bold text-2xl mb-1", children: step.num }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-white text-base mb-2", children: step.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/70 text-sm leading-relaxed", children: step.desc }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: step.image,
...
const FEATURES = [
  ...
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Shield, { size: 26, className: "text-white" }),
...
function Features() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "py-20", style: { background: "#130d2b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Key Features" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "Everything you need for proactive health management" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-6", children: FEATURES.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-white text-base mb-1", children: f.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/70 text-sm leading-relaxed", children: f.desc })
          ] })
        ]
      }
    ) }, f.title)) })
...
function ProblemSolution() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "problem", className: "py-20", style: { background: "#0f0a1e" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Problem & Solution" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto" })
    ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: { background: "rgba(239,68,68,0.15)" },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { size: 22, className: "text-red-400" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-bold text-xl text-white", children: "The Problem" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-purple-200/80", children: [
            ...
            ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-400 mt-0.5 flex-shrink-0", children: "✗" }),
              item
            ] }, item)) })
          ]
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: 150, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "rounded-2xl p-8 border-l-4 h-full",
          style: {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "w-10 h-10 rounded-xl flex items-center justify-center",
                  style: { background: "rgba(124,58,237,0.2)" },
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { size: 22, className: "text-purple-400" })
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-bold text-xl text-white", children: "Our Solution" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 text-purple-200/80", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-400 mt-0.5 flex-shrink-0", children: "✓" }),
              item
            ] }, item)) })
          ]
        }
...
function WhatElse() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "what-else", className: "py-20", style: { background: "#130d2b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "What Else It Solves" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: [
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Eye, { size: 30, className: "text-purple-400" }),
        title: "Hygiene Awareness",
        desc: "Educates users about proper menstrual hygiene practices through timely reminders and alerts."
      },
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { size: 30, className: "text-purple-300" }),
        title: "Infection Prevention",
        desc: "Proactively prevents bacterial and fungal infections by ensuring timely napkin changes."
      },
      {
        icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { size: 30, className: "text-violet-400" }),
...
function SDGGoals() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "sdg", className: "py-20", style: { background: "#0f0a1e" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "UN SDG Alignment" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "Our project contributes to three United Nations Sustainable Development Goals" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: [
      {
    ...
    ].map((sdg, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 120, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-white/20 flex items-center justify-center mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-black text-4xl text-white", children: sdg.num }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-poppins font-bold text-sm text-white", children: [
                  "SDG ",
                  sdg.num
                ] })
              ]
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-poppins font-semibold text-white text-sm mb-2", children: sdg.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200/70 text-xs leading-relaxed", children: sdg.desc })
              ]
            }
          )
        ]
...
function CostEstimation() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "cost", className: "py-20", style: { background: "#130d2b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Cost Estimation" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "Affordable components for maximum accessibility" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "rounded-2xl overflow-hidden border",
        style: { borderColor: "rgba(124,58,237,0.3)" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gradient-to-r from-purple-700 to-violet-700 px-6 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-semibold text-white text-sm", children: "Component" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-semibold text-white text-sm text-right", children: "Cost" })
          ] }) }),
          COST_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "px-6 py-4 grid grid-cols-2 gap-4 items-center",
              style: {
                background: i % 2 === 0 ? "rgba(124,58,237,0.06)" : "rgba(124,58,237,0.12)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-purple-100 text-sm", children: item.component }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-300 font-semibold text-sm text-right", children: item.cost })
              ]
            },
            item.component
          )),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-bold text-white text-sm", children: "Total" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-bold text-purple-300 text-base text-right", children: "₹250" })
              ]
            }
          )
        ]
...
function Statistics() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Menstrual Hygiene Access Gap" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300 max-w-lg mx-auto", children: "Only 36% of women in developing countries have access to proper hygiene products." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
        ] }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: 100, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-center gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "svg",
            {
              role: "img",
              ...
              viewBox: "0 0 200 200",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: describeArc(0, pinkEnd, pieR), fill: "#7c3aed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: describeArc(pinkEnd, 360, pieR), fill: "#a78bfa" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: CX, cy: CY, r: 40, fill: "#1a0f35" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "text",
                  {
                    x: CX,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-purple-600 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-white", children: "36% — Have Access" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300 text-sm", children: "Women with proper hygiene products" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-5 h-5 rounded-full bg-purple-300 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-white", children: "64% — Without Access" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300 text-sm", children: "Women lacking proper menstrual hygiene" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-purple-300", children: "Source:" }),
                  " ",
                  "WHO & UNICEF Joint Monitoring Programme, 2023. The Smart Napkin Monitor aims to bridge this critical gap."
                ]
              }
            )
          ] })
...
function Gallery() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "gallery", className: "py-20", style: { background: "#130d2b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Gallery" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "Circuit diagrams, wearable integration, and component visuals" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: GALLERY_ITEMS.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { delay: i * 80, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: item.image,
              alt: item.caption,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-poppins font-semibold text-purple-200 text-sm text-center", children: item.caption }) })
        ]
      }
    ) }, item.caption)) })
  ] }) });
...
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-20", style: { background: "#0f0a1e" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-poppins font-bold text-3xl sm:text-4xl text-white mb-3", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-300", children: "Have questions or want to collaborate? We'd love to hear from you." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-1 bg-purple-400 rounded mx-auto mt-3" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimSection, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          ].map((email) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "flex items-center justify-center gap-3",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { size: 18, className: "text-purple-400 flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
                  {
                    href: `mailto:${email}`,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 18, className: "text-purple-400 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-200 font-medium text-sm", children: "Rajalakshmi Institute of Technology" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: { borderColor: "rgba(124,58,237,0.3)" },
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-purple-300/70 leading-relaxed", children: "We are open to collaborations with NGOs, healthcare institutions, and technology partners to bring this solution to women globally." })
            }
          )
        ]
      }
...
function Footer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "py-10 px-4", style: { background: "#080514" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-full bg-purple-600 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Droplets, { size: 14, className: "text-white" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-poppins font-bold text-white text-sm", children: "Smart Sanitary Napkin Monitoring System" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-purple-400 text-xs", children: "Ready to Protect Women — Engineering Innovation Project" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-purple-500 text-xs", children: [
      "© ",
      year,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Feasibility, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(WhatElse, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SDGGoals, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CostEstimation, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Statistics, {}),
